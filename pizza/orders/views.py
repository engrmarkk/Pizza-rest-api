...
class OrderGetCreate(Resource):
    ...
    def post(self):
        ...
        new_order = Order(
            size=data["size"], quantity=data["quantity"], flavour=data["flavour"]
        )
...
class GetUpdateDelete(Resource):
    @order_namespace.marshal_with(order_model)
    @order_namespace.doc(
        description="Retrieve an order by ID", params={"order_id": "An ID for an order"}
    )
    @jwt_required()
    ...
    @order_namespace.marshal_with(order_model)
    @order_namespace.doc(
        description="Update an order by ID", params={"order_id": "An ID for an order"}
    )
    @jwt_required()
    ...
    @order_namespace.doc(
        description="Delete an order by ID", params={"order_id": "An ID for an order"}
    )
    @jwt_required()
...
class GetSpecificOrderByUser(Resource):
    ...
    @order_namespace.doc(
        ...
        params={"user_id": "An ID for a user", "order_id": "An ID for an order"},
    )
    @jwt_required()
...
class UserOrders(Resource):
    ...
    @order_namespace.doc(
        description="Get all orders by a user", params={"user_id": "An ID for a user"}
    )
    @jwt_required()
